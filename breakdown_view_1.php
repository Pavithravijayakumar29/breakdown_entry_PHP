   ...
   <link rel="stylesheet" type="text/css" href="jquery-ui-1.8.17.custom.css">
    ...
    <td width="92" rowspan="3"><img src="../image/logo_print.png" height="80" width="80" /></td>

    <td width="621" height="30" class="title" style=" font-weight:900; font-size:24px">&nbsp;<?php echo $company[0]; ?></td>
...
<tr>
	...
	<th  align="left" scope="col" colspan="3" class="main"><strong>Breakdown Entry View &nbsp;</strong></th>
	...
	<th width="16%" height="33" scope="col">&nbsp;</th>
...
$plant_name1=$record['plant_name'];
  ...
  $plant_id11= $party_names['plant'];
	...
	<td align="left" width="16%" class="main" scope="col"><strong>&nbsp; Breakdown No</strong></td>

	<td width="2%" class="main"  align="center"scope="col">&nbsp;:</td>

	<td width="40%" class="data"  align="left"scope="col"><?php echo $breakdown_no;?></td>

	
 
	<td width="12%"class="main" align="left"scope="col"><strong>Date </strong></td>

	<td width="4%" class="main" scope="col" align="center">&nbsp;:</td>

	<td width="10%" class="data" align="left" scope="col"><?php echo date('d-m-Y',strtotime($entry_date))?></td>
	...
	<td width="16%" class="style2"  align="center"scope="col">&nbsp;</td>

	

	<td align="left" width="16%" class="main" scope="col"><strong>&nbsp; Site Name </strong></td>

	<td width="2%" class="main"  align="center"scope="col">&nbsp;:</td>

	<td width="40%" class="data"  align="left"scope="col"><?php echo $site_name_edit;?></td>

	

	<td width="12%" class="main" align="left"scope="col"><strong> Plant Name</strong></td>

	<td width="4%" class="main" scope="col" align="center">&nbsp;:</td>

	<td width="10%" class="data" align="left" scope="col"><?php echo  $plant_id11;?></td>

	</tr>

	<tr>

	<td width="16%" height="30"  align="center" class="style2"scope="col">&nbsp;</td>

	

	<td align="left" width="16%" class="main" scope="col"><strong>&nbsp;Shift Name </strong></td>

	<td width="2%" class="main"  align="center"scope="col">&nbsp;:</td>

	<td width="40%" class="data"  align="left"scope="col"><?php echo $shift_name_edit; ?></td>

	

	<td width="12%" class="main" align="left"scope="col"><strong>&nbsp;Staff Name</strong></td>

	<td width="4%" class="main" scope="col" align="center">:</td>

	<td width="10%" class="data" align="left" scope="col"><?php echo $staff_name;?></td>
	...
	<th width="17%" height="34" class="" >&nbsp;</th>

	

	<th width="17%" height="34" class="style10 main " align="CENTER" >S.No</th>


	<th width="20%" class="style10 main " align="left"  >Breakdown Type&nbsp; </th>

	<th width="15%" class="style10 main " align="right"  >From Time &nbsp; </th>

	<th width="17%"  class="style10 main " align="right" >To Time&nbsp;</th>

	<th width="19%"  class="style10 main " align="right" >Total Time&nbsp;&nbsp;&nbsp;&nbsp;</th>

	<th width="12%" class="style10 main " align="left"  >Remarks&nbsp; </th>
	...
	<td width="1%" height="" class=" " ></td>

	<td colspan="6" align="center" class="style10 style4"></td>

	<td width="2%" height="" class=" " ></td>
   ...
   $tot[]=$total_time;
	...
	<td  width="1%" height="34" class="" ></td>

	<td align="right" colspan="3" height="34" class="data top" >&nbsp;</td>

	<td align="right" class="data    top " ><strong>Total Time&nbsp;</strong></td>

	<td align="right" class="data    top " ><strong><?php echo $t_time_tot;?></strong>&nbsp;&nbsp;&nbsp;&nbsp;</td>

	<td width="12%"  height=""  class="data    top "></td>
