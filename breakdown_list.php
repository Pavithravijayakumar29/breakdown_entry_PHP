...
else
{
 ...
 $sql1="select *,a.id as main_id,a.remarks as remarks from  breakdown_entry as a join breakdown_entry_sub as b on a.breakdown_no=b.breakdown_no and a.random_no=b.random_no and a.random_sc=b.random_sc where $get_query131 a.id!='' and a.site_name IN ($sess_site_id) group by a.breakdown_no order by a.id DESC";
}
