...
$breakdown_type = $_REQUEST['machinery_type'];
...
<select name="equipment_type" id="equipment_type" class="form-control ">
  ...
  /******************************************************************/
  if ($IN_vals != '') {
    $sql1 = "select * from   vehicle_entry where site_name='$site_name' and  equip_field!='Genset' and id IN ($IN_vals) and equipment_type='$_REQUEST[machinery_type]'  group by equipment_model order by  id ASC";
  } else {
