...
$plant_name1=$record['plant_name'];
  ...
  $plant_id11= $party_names['plant'];
	...
	<th width="11%" class="style10 main " align="left"  >Remarks&nbsp; </th>
    ...
    $equipment_type=get_plant_equipment_name($fetch_list2['equipment_type']);
	...
	<td align="left" class="data " ><?php echo $remarks;?>&nbsp;</td>
		<td align="left" class="data " ><?php if($machinery_type!=''){echo $machinery_type;}else{ echo "--";}?>&nbsp;</td>
   ...
   $tot[]=$total_time;
	...
	<td align="right" colspan="5" width="7%" height="34" class="data top" >&nbsp;</td>
	...
	<td width="3%"  height=""  class="data    top "></td>
