...
<script>
    function excel_value(from_date,to_date,type_v,site_name,breakdown_type){
 

// console.log("from_date :" +from_date);
// console.log("to_date :" +to_date);
// console.log("type_v :" +type_v);
 console.log("site_name:" +site_name);
 console.log("breakdown_type:" +breakdown_type);


 window.location.href="breakdown_entry/stock_excel_list_breakdown_entry.php?from_date="+from_date+"&to_date="+to_date+"&type="+type_v+"&site_name="+site_name+"&breakdown_type="+breakdown_type;
...
<!---------edit_starts---------------------->
<img align="right" src="image/excel-icon.png" onclick="excel_value(from_date.value,to_date.value,type_v.value,site_name.value,breakdown_type.value)"
 width="35" height="35" title="Click to export sublist" />
